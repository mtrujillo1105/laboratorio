...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-08-2021 a las 03:35:09
...
--
-- Estructura de tabla para la tabla `bitacora_seguimiento`
--
...
CREATE TABLE `bitacora_seguimiento` (
  ...
  `usuario_modificacion` bigint(20) DEFAULT NULL,
  `flag_historico` tinyint(1) DEFAULT 0,
  `fecha_seguimiento` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `bitacora_seguimiento`
--

INSERT INTO `bitacora_seguimiento` (`id_seguimiento`, `id_cotizacion`, `titulo`, `mensaje`, `fecha_registro`, `usuario_registro`, `fecha_modificacion`, `usuario_modificacion`, `flag_historico`, `fecha_seguimiento`) VALUES
(1, 5, 'seguimiento 1', 'Se llama al cliente', '2021-08-11 14:52:44', 7, '2021-08-11 00:00:00', 7, 0, '2021-08-11'),
(2, 3, 'LLAMADA', 'Llame al cliente a las 9 am', '2021-08-11 15:20:44', 7, NULL, NULL, 0, '2021-08-11'),
(3, 3, 'Descuento', 'Se le realizo un descuento a la cotizacion', '2021-08-11 15:21:14', 7, NULL, NULL, 0, '2021-08-11');
...
(1, 'Roberto Meiggs', 'rmeiggs.s@gmail.com', '920183716', 1, NULL, NULL),
(2, 'Carla', 'carla@correo.com', '15410211', 1, NULL, NULL);
...
CREATE TABLE `cotizacion` (
  ...
  `COTIC_SubTotal` decimal(10,4) DEFAULT NULL,
  `COTIC_Igv` decimal(10,4) DEFAULT NULL,
  `COTIC_Total` decimal(10,4) DEFAULT NULL,
...
(3, 1, 2, 7, '001-56123', NULL, NULL, '2500.0000', '450.0000', '2950.0000', '2021-08-10 00:00:00', NULL, '2021-08-16 20:41:08', '2021-08-11 02:00:33', 'correo@correo.com', '', '', '', NULL, 0, '0.00', '0.00', '2500.00'),
(4, 3, 2, 7, '001-85611', NULL, NULL, '4000.0000', '0.0000', '3600.0000', '2021-08-10 00:00:00', NULL, '2021-08-16 20:58:23', '2021-08-11 02:31:29', '', '', '', '', NULL, 0, '10.00', '400.00', '3600.00'),
(5, 2, 2, 7, '001-51212', NULL, NULL, '750.0000', '135.0000', '885.0000', '2021-08-11 00:00:00', NULL, '2021-08-16 20:53:07', '2021-08-11 14:52:13', '', '', '', '', NULL, 0, '0.00', '0.00', '750.00'),
(6, 1, 1, 7, '100-454', NULL, NULL, '2000.0000', '360.0000', '2360.0000', '2021-08-16 00:00:00', NULL, '2021-08-16 20:51:12', '2021-08-16 23:49:21', '', '', '', '', NULL, 0, '0.00', '0.00', '2000.00');
...
--
-- Volcado de datos para la tabla `cotizacion_capacitacion`
--

INSERT INTO `cotizacion_capacitacion` (`COCAP_Codigo`, `COTIP_Codigo`, `id_curso`, `COCAC_Detalle_Curso_Cotizar`, `COCAC_Horario_Tentativo_Curso`, `COCAC_Lugar_Capacitacion`, `COCAC_Cantidad`, `COCAC_Costo_Curso_Original`, `COCAC_SubTotal`, `COCAC_Descuento_Porcentaje`, `COCAC_Descuento_Moneda_Real`, `COCAC_SubTotal_Descontado`, `COCAC_FechaRegistro`, `COCAC_FechaModificacion`) VALUES
(6, 4, 1, NULL, 'De 10 am a 2 pm', 3, 20, '200.00', '4000.00', 0, '0.00', '4000.00', '2021-08-17 01:58:23', NULL);
...
(12, 3, 'equipo1', 'equipo1', 'equipo1', 'equipo1', 'equipo1', 'null', NULL, '250.00', 10, '2500.00', '2021-08-17 01:41:08', NULL, '0.00', '0.00', '2500.00'),
(16, 6, 'equipo1', 'e', 'equipo1', 'ewqsadsad', 'sadsadsa', 'null', NULL, '200.00', 10, '2000.00', '2021-08-17 01:51:12', NULL, '0.00', '0.00', '2000.00'),
(18, 5, 'equipo1', 'equipo1', 'equipo1', 'equipo1', 'equipo1', 'null', NULL, '150.00', 5, '750.00', '2021-08-17 01:53:08', NULL, '0.00', '0.00', '750.00');
...
(1, 'PHP Nivel 1', 'PHP Nivel 1', '200.00', '1', NULL),
(2, 'PHP Nivel 2', 'PHP Nivel 2', '250.00', '1', NULL);
...
CREATE TABLE `parametro` (
  ...
  `id_parametro_padre` char(4) DEFAULT NULL,
...
INSERT INTO `parametro` (`id_parametro`, `nombre`, `id_parametro_padre`, `eliminado`) VALUES
('E001', 'Variables PDF', NULL, b'0'),
('L001', 'Lugar de Capacitacion', NULL, b'0'),
('P001', 'Parametros Sistema', NULL, b'1');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `parametro_valor`
--

CREATE TABLE `parametro_valor` (
  `id_parametro_valor` char(8) NOT NULL,
  `id_parametro` char(4) DEFAULT NULL,
  `id_parametro_valor_padre` char(8) DEFAULT NULL,
  `nombre` varchar(100) DEFAULT NULL,
  `valor` varchar(500) DEFAULT NULL,
  `valor_adicional_1` varchar(500) DEFAULT NULL,
  `valor_adicional_2` varchar(200) DEFAULT NULL,
  `valor_adicional_3` varchar(200) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `parametro_valor`
--

INSERT INTO `parametro_valor` (`id_parametro_valor`, `id_parametro`, `id_parametro_valor_padre`, `nombre`, `valor`, `valor_adicional_1`, `valor_adicional_2`, `valor_adicional_3`, `activo`, `eliminado`, `orden`) VALUES
('ED00001', 'E001', NULL, 'Datos Cta Corriente', NULL, NULL, NULL, NULL, b'1', b'0', NULL),
('EDC0001', 'E001', 'ED00001', 'Cta Cte', 'CTA. CTE - 000-2109263 87%', '0.87', NULL, NULL, b'1', b'0', NULL),
('EDC0002', 'E001', 'ED00001', 'CCI', 'CCI-009-214-000002109263-80', NULL, NULL, NULL, b'1', b'0', NULL),
('EDC0003', 'E001', 'ED00001', 'CTA. DETRACCION', 'CTA. DETRACCION - 0000513431 12% (BANCO DE LA NACIÓN)', '0.12', NULL, NULL, b'1', b'0', NULL),
('EDC0004', 'E001', '', 'Banco Deposito', 'BANCO SCOTIABANK', 'Titulo', NULL, NULL, b'1', b'0', NULL),
('EDT00001', 'E001', NULL, 'Texto Detracción', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer gravida varius magna id tempor. Ut suscipit tellus eu arcu euismod, a ultricies augue iaculis. Quisque id placerat quam. Suspendisse potenti. Duis ac ex a velit tincidunt imperdiet. Fusce at tortor ac nunc ullamcorper feugiat ut a justo. Duis interdum feugiat quam non tincidunt.', NULL, NULL, NULL, b'1', b'0', NULL),
('EJ000001', 'E001', NULL, 'Nombre Jefe Laboratorio', 'Ing. Edward Figueroa', NULL, NULL, NULL, b'1', b'0', NULL),
('EP000001', 'E001', NULL, 'Texto Pie de pagina', 'Av. Tupac Amaru 210 Pabellon A, primer piso, Lima 25, Apartado postal 1301 - Perú.<br>Teléfono: (511) 381-3342 Central Teléfónica: (511) 381-1070 Anexos 4836-4835-4840 <br> Sitio Web:http://www.lefiee.uni.edu.pe -Email:labl1fiee@uni.edu.pe', NULL, NULL, NULL, b'1', b'0', NULL),
('L00001', 'L001', NULL, 'Oficinas de la Empresa', '1', NULL, NULL, NULL, b'1', b'0', NULL),
('L00002', 'L001', NULL, 'Laboratorio de Electricidad', '2', NULL, NULL, NULL, b'1', b'0', NULL),
('L00003', 'L001', NULL, 'Cualquiera de las dos opciones', '3', NULL, NULL, NULL, b'1', b'0', NULL),
('P0000001', 'P001', NULL, 'Ocultar Descuentos', '1', NULL, NULL, NULL, b'1', b'1', NULL);
...
(11, 12, 'prueba1', 'prueba1', 'prueba1', NULL, '250.00', NULL, NULL),
(13, 16, 'dasdsa', 'dsad', 'sadsa', NULL, '0.00', NULL, NULL);
...
(1, 1, '150101', 'Cofima', '20512988758', 'Jr. Miguel Aljovin 240', '920183716', 'jaredn2021@gmail.com', '1', NULL, '2021-08-11 01:55:12', NULL, NULL);
...
(1, 'Ensayo', NULL, NULL),
(2, 'Calibracion', NULL, NULL),
(3, 'Capacitacion', NULL, NULL);
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `flag_activo` bit(1) NOT NULL DEFAULT b'1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `ROL_Codigo`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `flag_activo`) VALUES
(6, 1, 'Martin Trujillo Bustamante', 'martin.trujillo@uni.pe', NULL, '$2y$10$l4MY6hm3RouXwKlVTQwN5.pyyxmfZSqIFccF05zovY26lpxYTLoM6', NULL, '2020-09-15 03:21:18', '2020-09-15 21:19:17', b'1'),
(7, 1, 'Alexander Figueroa', 'edward.figueroa@uni.pe', NULL, '$2y$10$p1jtAToBllIz8S7jb0bfW.LHhdH8dubiVF3b0QApy3GZtCm04l9z2', NULL, '2020-09-15 21:21:18', '2020-09-15 21:21:18', b'1'),
(8, 1, 'Diego', 'reshinger@gmail.com', NULL, '$2y$10$xWEKuWVJmpDd.UA3SENcz.Qi6dMFabIui9lfVbLDkAx4QSjzvZMF6', NULL, '2020-11-04 20:38:57', '2020-11-04 20:38:57', b'1'),
(9, 2, 'Pier', 'Black@gmail.com', NULL, 'qweasdzxc', NULL, '2020-11-04 22:01:20', '2020-11-04 22:01:20', b'1'),
(10, 1, 'Laravel 8', 'panaca@gmail.com', NULL, 'eyJpdiI6Ik5GVTB4TEx1SGlsdWZ6MklxU25CQnc9PSIsInZhbHVlIjoiZ2J0Ykl3d3hBUENuZmRTc0w0UWNqUT09IiwibWFjIjoiNGM1MmRiM2RhZTQzNjU3Zjk5OGEzYTQxMDYyZDU5MTQ3N2QxZDE2NDlkMzMzNGYzMDhlNTUzMDM4YjZjNDFmNSJ9', NULL, '2020-11-04 22:31:18', '2020-11-04 22:31:18', b'1'),
(11, 1, 'Roberto', 'rmeiggs.s@gmail.com', NULL, '$2y$10$1v6gfWpOE8fjH3cmlcZRKOS693LAIN2T72bSYruNcrWcuoMBEzj8e', NULL, '2021-03-22 02:45:13', '2021-03-30 23:48:34', b'1'),
(13, 2, 'Luis', 'luis@gmail.com', NULL, 'eyJpdiI6IjdYOXZpTlNabFppZXl1eWV6VUVvaEE9PSIsInZhbHVlIjoidy9peC9mUXRiSnhUMStDZVUxcFVjZz09IiwibWFjIjoiZGM0OGZiNTEyOTFkMzIwMjRkZjA5ZjczZTAxMzM0ZmRhNDc0Y2YwNjU2ZjE1ZTkyNWE0YjkzZTI1MjkyOTczZiJ9', NULL, '2021-03-23 02:46:27', '2021-03-23 02:46:27', b'1'),
(14, 1, 'Roberto Meiggs Sotelo', 'roberto@gmail.com', NULL, '$2y$10$KLhMncPxUTha6zp3WLllhua988cdzKEqBPmoPeUuBgjdJs20B.HEy', NULL, '2021-03-25 02:29:41', '2021-03-30 23:58:37', b'1'),
(15, 1, 'prueba', 'prueba@gmail.com', NULL, '$2y$10$DfsA9S/wED015lAwgpwjcO5Ty24SwSkmYbMxhMZpdD97Jr1fWDJPq', NULL, '2021-03-30 22:52:16', '2021-03-30 23:40:39', b'1'),
(16, 1, 'prueba2', 'juancargoso@gmail.com', NULL, '$2y$10$AwbGQo9Z0Ub9JfqkaRwizOE0rZfiw7w0Hb2t58d9rwq7mFHP0laTm', NULL, '2021-03-30 23:46:46', '2021-03-30 23:46:46', b'1'),
(19, 2, 'Jose Luis', 'jluis@gmail.com', NULL, '$2y$10$olx0pkt7VhcnxWFXxQvr0u/taksA.qBAinSdTtycvhyBmnca0iaaq', NULL, '2021-03-31 03:10:18', '2021-04-09 18:26:06', b'1'),
(20, 2, 'Juan Perez', 'jperez@gmail.com', NULL, '$2y$10$soDl9LFKRBvS6qM2tlejE.o8swNtcrvsTB0hyfrzQ2WerVyUjcXxq', NULL, '2021-04-08 02:49:35', '2021-04-09 18:25:58', b'1'),
(21, 2, 'Ivan Tapia', 'itapia@gmail.com', NULL, '$2y$10$DsqmiuWVluwtjLnl20kM/OWk9BslIk5L0dk0bV1lPPN9zMsmsdlM2', NULL, '2021-04-08 02:50:23', '2021-04-09 18:26:00', b'1'),
(22, 2, 'Luis Quispe', 'lquispe@gmail.com', NULL, '$2y$10$3mqmLXAtrVZ16PaDzCbOteXKVFIO9F1AIr.bMlypQyC/o6tpik2o.', NULL, '2021-04-08 02:50:58', '2021-04-09 18:26:03', b'1'),
(23, 1, 'Juan Mauro', 'jmauro@gmail.com', NULL, '$2y$10$vHqpehbffCvbmcA8YeBJxO34ZOYmvJBdjTwP5Pp.N7gF.d2swKs8G', NULL, '2021-04-14 00:21:36', '2021-04-17 02:08:34', b'0'),
(24, 2, 'Yerson Huincho', 'yhuincho@gmail.com', NULL, '$2y$10$Ci8YmZcDajTxJTg3uUUcIOqRzTO0LFWLAx/hIwnlc2wcuY.0dOuFC', NULL, '2021-04-14 02:17:23', '2021-04-14 02:18:22', b'0'),
(25, 2, 'Marck Llerena', 'mllerena@gmail.com', NULL, '$2y$10$IwTcirFo5N5zCs5ALzSFB.ClfKDAPR9LBOGy2ue3yN8cBjusl7//O', NULL, '2021-04-14 02:19:15', '2021-04-15 13:42:18', b'0');
...
CREATE TABLE `usuario` (
  ...
  `flag_activo` bit(1) NOT NULL DEFAULT b'0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indices de la tabla `bitacora_seguimiento`
--
ALTER TABLE `bitacora_seguimiento`
...
--
-- Indices de la tabla `parametro_valor`
--
ALTER TABLE `parametro_valor`
  ADD PRIMARY KEY (`id_parametro_valor`) USING BTREE,
...
--
ALTER TABLE `asesoria`
  MODIFY `id_asesoria` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `bitacora_seguimiento`
--
ALTER TABLE `bitacora_seguimiento`
  MODIFY `id_seguimiento` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `cotizacion`
  MODIFY `COTIP_Codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `cotizacion_capacitacion`
--
ALTER TABLE `cotizacion_capacitacion`
  MODIFY `COCAP_Codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `cotizacion_detalle`
--
ALTER TABLE `cotizacion_detalle`
  MODIFY `CODEP_Codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `horario_apertura_curso`
  MODIFY `ID_Horario_apertura_curso` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `horario_instructor`
--
ALTER TABLE `horario_instructor`
  MODIFY `id_horario_instructor` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `instructor`
--
ALTER TABLE `instructor`
  MODIFY `INSTP_Codigo` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `prueba_equipo`
  MODIFY `id_prueba_a_realizar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `servicio_academico`
  MODIFY `id_servicio_acad` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `solicitante`
--
ALTER TABLE `solicitante`
  MODIFY `SOLIP_Codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Filtros para la tabla `bitacora_seguimiento`
--
ALTER TABLE `bitacora_seguimiento`
  ADD CONSTRAINT `bitacora_seguimiento_ibfk_1` FOREIGN KEY (`id_cotizacion`) REFERENCES `cotizacion` (`COTIP_Codigo`);
...
--
-- Filtros para la tabla `parametro_valor`
--
ALTER TABLE `parametro_valor`
  ADD CONSTRAINT `parametro_valor_ibfk_1` FOREIGN KEY (`id_parametro`) REFERENCES `parametro` (`id_parametro`);
