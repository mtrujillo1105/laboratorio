              ...
              <div class="card-header">
                <h5 class="mb-0 row">
                  <div class="col-9 d-flex">
                    <div class="p2 text-uppercase">{{ seguimiento.titulo }}</div>
                  ...
                  <div class="col-auto">
                    ...
                    <button class="btn btn-danger" @click="eliminarSeguimiento(seguimiento.id_seguimiento)">
                  Eliminar
                    </button>
                  </div>
                </h5>
...
export default {
  ...
  methods: {
    ...
    btnBorrar(cotizacion, indice) {
      let _this = this;
      let url = "/cotizacioncapacitacion/delete/" + cotizacion.COTIP_Codigo;
      axios
        .delete(url)
    ...
    btnEditar(id) {
      location.href = "/capacitacion/" + id + "/edit";
    },
    btnNuevo() {
      location.href = "/capacitacion/create";
    },
  },
};
</script>
