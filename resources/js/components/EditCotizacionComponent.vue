...
<template>
  ...
  <div class="invoice p-3 mb-3">
      ...
      <div class="row row-sm invoice-info">
        ...
        <div class="col-sm-3 invoice-col">
          <div class="row form-group">
            ...
            <input
              type="date"
              class="col-sm-6 form-control-sm"
              v-model="cotizacion.COTIC_Fecha"
              autocomplete="off"
              name="fecha"
              ref="fecha"
            />
        ...
        <div class="col-sm-2 invoice-col">
          <div class="row form-group" v-if="mostrarNumeroCotizacion">
            ...
            <input
              type="text"
              v-model="cotizacion.COTIC_Numero"
              class="col-sm-6 form-control-sm"
              maxlength="11"
              autocomplete="off"
              name="numero"
        ...
        <div class="col-sm-3 invoice-col">
          <div class="form-group form-check">
            <input
              ...
              name="chkPedido"
              id="chkPedido"
              v-model="cotizacion.COTIC_flag_pedido"
            />
            <label for="chkPedido" class="col-check-label"
              >La cotizacion se transformo en Pedido</label
            >
          </div>
        </div>
      </div>
      ...
      <div class="row row-sm invoice-info">
        <div class="col-sm-4 invoice-col">
          <div class="row form-group">
            ...
            >
            <select
              v-model="cotizacion.id_contacto"
              class="col-sm-6 form-control-sm"
              name="contacto"
              ref="contacto"
              @change="mostrarDatosContacto()"
            >
              <option
                v-for="contacto in contactos"
                v-bind:value="contacto.id_contacto"
                v-bind:key="contacto.id_contacto"
              >
        ...
        <div class="col-sm-4 invoice-col">
          <div class="row form-group">
            ...
            <input
              type="text"
              v-model.number="cotizacion.correo_contacto"
              id="correoContacto"
              class="col-sm-6 form-control-sm"
              readonly
            />
        ...
        <div class="col-sm-4 invoice-col">
          <div class="row form-group">
            ...
            <input
              type="text"
              v-model.number="cotizacion.celular_contacto"
              class="col-sm-6 form-control-sm"
              readonly
            />
          </div>
          ...
          <div class="row form-group">
            ...
            >
              ...
              <option
                ...
                v-bind:value="departamento.UBIGC_CodDpto"
                v-bind:key="departamento.UBIGC_CodDpto"
              >
                {{ departamento.UBIGC_Descripcion }}
              </option>
            </select>
          </div>
        </div>
          ...
          <div class="row form-group">
            ...
            >
              ...
              <option
                ...
                v-bind:value="provincia.UBIGC_CodProv"
                v-bind:key="provincia.UBIGC_CodProv"
              >
                {{ provincia.UBIGC_Descripcion }}
              </option>
            </select>
          </div>
        </div>
          ...
          <div class="row form-group">
            ...
            >
              ...
              <option
                ...
                v-bind:value="distrito.UBIGC_CodDist"
                v-bind:key="distrito.UBIGC_CodDist"
              >
                {{ distrito.UBIGC_Descripcion }}
              </option>
            </select>
          </div>
        </div>
          ...
          <table class="table table-striped table-sm">
            <thead>
              <tr class="text-center">
                ...
                <th style="width: 5%" v-if="!ocultarDescuentos">Dscto.(%)</th>
                <th style="width: 5%" v-if="!ocultarDescuentos">
                  Subtotal Dscto.
                </th>
              </tr>
            </thead>
              ...
              <tr class="text-center" v-for="(equipo, index) in equipos">
                ...
                <td>
                  <input
                    ...
                    name="nombre[]"
                    v-model="equipo.CODEC_Nombre_Equipo"
                    autocomplete="off"
                  />
                </td>
                <td>
                  <input
                    ...
                    class="form-control-sm w-100"
                    name="descripcion[]"
                    v-model="equipo.CODEC_Descripcion_Equipo"
                    autocomplete="off"
                  />
                </td>
                <td>
                  <input
                    ...
                    class="form-control-sm w-100"
                    name="fabricante[]"
                    v-model="equipo.CODEC_Fabricante_Equipo"
                    autocomplete="off"
                  />
                </td>
                <td>
                ...
                <td>
                  <button
                    ...
                    @click="openListPruebas(index)"
                    title="Agregar prueba al equipo"
                  >
                ...
                <td>
                  <input
                    type="text"
                    class="form-control-sm w-100 text-right"
                    name="unitario"
                    ref="unitario"
                    v-model.number="equipo.CODEC_Costo"
                    autocomplete="off"
                    @keypress="restringirSoloNumerosDecimales($event)"
                    @focusin="capturarCosto(index)"
                    @focusout="
                ...
                <td>
                  <input
                    ...
                    class="form-control-sm w-100 text-right"
                    name="cantidad[]"
                    v-model.number="equipo.CODEC_Cantidad"
                    autocomplete="off"
                    @keypress="restringirSoloNumerosEnteros($event)"
                    @focusout="realizarCalculosDeEnsayo(index)"
                  />
                </td>
                <td>
                  <input
                    ...
                    name="subtotaldet[]"
                    v-model.number="
                      isNaN(equipo.CODEC_SubTotal) ||
                      equipo.CODEC_SubTotal == ''
                        ? '0.00'
                        : parseFloat(equipo.CODEC_SubTotal).toFixed(2)
                    "
                    autocomplete="off"
                    readonly="readonly"
                    style="background-color: #2883f5; color: #ffffff"
                  />
                </td>
                <td v-if="!ocultarDescuentos">
                  <input
                    type="text"
                    class="form-control-sm w-100 text-right"
                    name="dcto_porcentaje[]"
                    v-model.number="equipo.CODEC_dcto_porcentaje"
                    autocomplete="off"
                    @keypress="restringirSoloNumerosDecimales($event)"
                    @focusout="realizarCalculosDeEnsayo(index)"
                    style="
                      background-color: rgb(230, 66, 16);
                ...
                <td v-if="!ocultarDescuentos">
                  <input
                    ...
                    name="dcto_subtotal[]"
                    v-model.number="
                      isNaN(equipo.CODEC_dcto_subtotal) ||
                      equipo.CODEC_dcto_subtotal == '' ||
                      equipo.CODEC_dcto_subtotal == null
                        ? parseFloat(equipo.CODEC_SubTotal).toFixed(2)
                        : parseFloat(equipo.CODEC_dcto_subtotal).toFixed(2)
                    "
                    autocomplete="off"
                    readonly
                    style="
                      background-color: rgb(0, 156, 48);
                      color: rgb(255, 255, 255);
                    "
                  />
                </td>
              ...
              <tr>
                <td class="text-right" colspan="2">
                  ...
                  <input
                    ...
                    v-model="SubTotal"
                    name="subtotal"
                    class="form-control-sm w-25 text-right"
                    readonly="readonly"
                  />
                </td>
              </tr>
              <tr>
                <td class="text-right">
                  ...
                  <input
                    type="text"
                    name="subtotal"
                    class="form-control-sm w-50 text-right"
      ...
      <div class="row text-left">
        <div class="col text-left">
          <button
            type="button"
            class="btn btn-info"
            id="btn-actualizar-cotizacion-ensayo"
            @click="updateCotizacion(equipos)"
          >
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <textarea
                    style="resize: none"
                    class="form-control"
                    v-model="equipo.CODEC_Descripcion_Ficha_Tecnica_Equipo"
                    rows="3"
                    cols="5"
                    name="ficha[]"
                  ></textarea>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <input
                    type="text"
                    class="form-control"
                    v-model="equipo.CODEC_Url_Ficha_Tecnica_Equipo"
                    name="url[]"
                  />
                </div>
              </div>
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <input
                    type="file"
                    class="form-control"
                    id="archivoFichaTecnica"
                  />
                  <p class="font-weight-bold">
                    <a
                      href="javascript:void(0);"
                      @click="downloadFileEquipo()"
                      >{{ equipo.nombre_archivo }}</a
                    >
                  </p>
                </div>
              </div>
    ...
    <div
      ...
      tabindex="-1"
      role="dialog"
      aria-labelledby="modal-prubas-label"
      aria-hidden="true"
      data-keyboard="false"
      data-backdrop="static"
    >
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="myModalLabel">
              {{
                equipo.CODEC_Nombre_Equipo != "" &&
                equipo.CODEC_Nombre_Equipo != undefined
                  ? "Pruebas de Equipo " + equipo.CODEC_Nombre_Equipo
                  : "Pruebas de Equipo"
              }}
            </h5>
          </div>
          <div class="modal-body">
            <div class="container">
              <div class="row mb-2">
                <div class="col-md-3">
                  <label class="col-form-label col-form-label-sm"
                    >Descripción de la Prueba:</label
                  >
                </div>
                <div class="col-md-9">
                  <input
                  ...
                  <textarea
                    ...
                    rows="2"
                    cols="5"
                    v-model="prueba.Descripcion_Prueba"
                  ></textarea>
                </div>
              </div>
              <div class="row mb-2">
                <div class="col-md-3">
                  <label
                    ...
                    for="ejemplo_archivo_1"
                    >Archivo de la Norma Técnica Asociada:</label
                  >
                </div>
                <div class="col-md-9">
                  <input
                  ...
                  <p class="font-weight-bold">
                    <a
                      href="javascript:void(0);"
                      @click="downloadFilePruebas()"
                      >{{ prueba.nombre_archivo }}</a
                    >
                  </p>
                </div>
              </div>
              <div class="row mb-2">
                <div class="col-md-3">
                  <label class="col-form-label col-form-label-sm"
                    >Norma Técnica Asociada:</label
                  >
                </div>
                <div class="col-md-5">
                  <input
                    class="form-control"
                    ref="NormaTecnicaAsociadaPrueba"
                    v-model="prueba.Norma_Asoc_Prueba"
                  />
                </div>
                <div class="col-md-1">
                ...
                <div class="col-md-3">
                  <input
                    class="form-control costo-prueba"
                    ref="costo_prueba"
                    v-model="prueba.Costo"
                    @keypress="restringirSoloNumerosDecimales($event)"
                    @focusout="formatearDecimales($event, $event.target)"
                  />
                </div>
              </div>
              <div class="row mb-2">
                <div class="col-md-3">
                  <label class="col-form-label col-form-label-sm"
                    >Descripción de la Norma Técnica Asociada:</label
                  >
                </div>
                <div class="col-md-9">
                  <textarea
                    ...
                    rows="2"
                    cols="5"
                    v-model="prueba.Descripcion_Norma"
                  ></textarea>
                </div>
              </div>
              <div class="row my-2">
            ...
            <div class="container mt-4">
              <table class="table table-bordered table-sm">
                ...
                <template v-if="pruebas.length > 0">
                  <tr
                    v-for="(prueba, indice) in equipo.pruebas"
                    :key="prueba.indice"
                  >
    ...
    export default {
        ...
        methods: {
            ...
            downloadPdf: async function() {
                if (!this.cotizacionInvalida()){
                    this.loadingPdf = true;

                    await this.guardarCotizacion();

                    var url = '/cotizacion/pdf';
                    const response = await axios({
                        url: url,
                        method: 'post',
                        responseType: 'blob',
                        data: {
                            'idSolicitante': this.solicitanteSelected,
                            'cotizaciones': this.equipos,
                            'subtotal' : this.SubTotal,
                            'igv': this.Igv,
                            'descuento': this.DescuentoPorcentaje,
                            'descuentoImporte': this.SubtotalDescuento,
                            'total': this.Total,
                            'nroCotizacion': this.cotizacion.COTIC_Numero,
            ...
            cotizacionInvalida(){
                ...
                if (typeof this.cotizacion.id_contacto == "undefined" || this.cotizacion.id_contacto == '') {
                  ...
                  this.mostrarMensajeInformacion('¡Debe ingresar el número de cotización!', 'warning');
            ...
            updateCotizacion: async function() {
                if (!this.cotizacionInvalida())
                {
                    this.mostrarMensajeConfirmacion('¿Está seguro de actualizar la cotización?', 'Si, actualizar', 'No, cancelar').then(async (result) => {
                        if (result.isConfirmed) {
                            try {
                                let response = await this.guardarCotizacion();
